...
ImageButton.Image = "http://www.roblox.com/asset/?id=18256954669"
...
Tabs.profile:AddParagraph({
        Title = "Owner",
        Content = "by Thế Giới Game"
    })
  
Tabs.profile:AddParagraph({
        Title = "link Discord Anonymous hub",
        Content = "discord.gg/2gy66CKwqk"
    })      
--------------------------------------------------------------------------------------------------------------------------------------------
--Hop
...
warn("Thank you for using the hack")
